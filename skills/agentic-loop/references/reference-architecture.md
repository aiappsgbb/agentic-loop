...
| Foundry IQ | Grounded knowledge, retrieval, vector/hybrid search, OCR/document extraction, speech features | Azure AI Search, Azure AI Document Intelligence, Azure AI Speech | `microsoft/azure-skills` / `azure-ai` — for agentic-retrieval grounding (retrieval identity, deterministic refusal, ACL, validation) see [`foundry-iq-grounding.md`](foundry-iq-grounding.md) |
